...
echo $CLASSPATH
java -Dlog4j.configuration=org/apache/zookeeper/graph/log4j2.properties -Xdebug -Xrunjdwp:transport=dt_socket,address=4444,server=y,suspend=n -cp $CLASSPATH org.apache.zookeeper.graph.LogServer $*
